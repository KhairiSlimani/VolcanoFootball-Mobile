...
public class StatistiqueProduits extends BaseForm {
    ...
    public StatistiqueProduits(Resources res)  {
        ...
        statistique.addActionListener((e)->{
                  new StatistiqueProduits(res).show();
    ...
    public void Statistique()
    {
        ...
        String []messages = {
            "Statistiques des produits par rapport la taille"  
        };
