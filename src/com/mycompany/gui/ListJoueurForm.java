 ...
 * @author jrady
 */
public class ListJoueurForm extends BaseForm {
      Form current;
      
      public ListJoueurForm (Resources res)
    {
        ...
        add(LayeredLayout.encloseIn(
                GridLayout.encloseIn(1, joueurs),
        ...
        ArrayList<Joueur>list = ServiceJoueur.getInstance().AfficherJoueurs();
