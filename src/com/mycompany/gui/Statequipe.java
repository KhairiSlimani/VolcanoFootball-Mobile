 ...
 * @author jrady
 */
public class Statequipe extends BaseForm{
    ...
    Form current;
BaseForm form;
        public Statequipe(Resources res)  {
        ...
        addTab(swipe, res.getImage("back-logo.jpeg"), spacer1,"");
        ...
        add(LayeredLayout.encloseIn(
                GridLayout.encloseIn(1, profile),
  ...
  ;       
    ...
    public void createPieChartForm() {
        ...
        ArrayList<Equipe>list = ServiceEquipe.getInstance().NomEquipes();
        ...
        for(Equipe e : list)
        {
            ...
            array2.add( ServiceJoueur.getInstance().NbrJoueur(e.getId()).size());
        ...
        //colors set:
        //int[]colors = new int[]{0xf4b342, 0x52b29a, 0xf4b342, 0x52b29a,0xf4b342, 0x52b29a};
        ...
        //CREATe the chart ...
        PieChart chart = new PieChart(buildDataset("title",array1,array2), renderer);
        
       
        ChartComponent c  = new ChartComponent(chart);
        
        String []messages = {
            "Nombre Joueur par Equipe"
        };
    ...
    private CategorySeries buildDataset(String title, ArrayList<String> array1, ArrayList<Integer> array2) {
        
        CategorySeries series = new CategorySeries(title);
        int k = 0;
        for (int value : array2 ) {
            series.add(array1.get(k), value);
            k++;
        }
