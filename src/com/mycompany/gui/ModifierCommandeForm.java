...
public class ModifierCommandeForm extends BaseForm {
    ...
    public ModifierCommandeForm (Resources res, Commande c)
    {
        ...
        TextField quantite = new TextField(String.valueOf(c.getQuantite()), "Quantité" , 20 , TextField.ANY);
        TextField adresse = new TextField(c.getAdresse(), "Adresse" , 20 , TextField.ANY);
        ...
        btnModifier.addPointerPressedListener(l -> { 
            ...
            c.setQuantite(Integer.parseInt(String.valueOf(quantite.getText()).toString()));
            c.setAdresse(String.valueOf(adresse.getText()));

            ServiceCommande.getInstance().ModifierCommande(c);
            new MesCommandesForm(res).show();
