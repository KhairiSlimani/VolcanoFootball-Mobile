...
public class AjouterReservation extends BaseForm {
      Form current;
    public AjouterReservation (Resources res, Hebergement h)
    {
        ...
        RadioButton Reserver = RadioButton.createToggle("Reserver", barGroup);
        Reserver.setUIID("SelectBar");
        ...
        add(LayeredLayout.encloseIn(
                GridLayout.encloseIn(1, Reserver),
                FlowLayout.encloseBottom(arrow)
        ));

        Reserver.setSelected(true);
        arrow.setVisible(false);
        addShowListener(e -> {
            arrow.setVisible(true);
            updateArrowPosition(Reserver, arrow);
        });
        bindButtonSelection(Reserver, arrow);
        ...
        btnAjouter.addActionListener((e) -> {
            ...
            try{
                ...
                else
                {
                    ...
                    ServiceReservation.getInstance().AjouterReservation(r);
