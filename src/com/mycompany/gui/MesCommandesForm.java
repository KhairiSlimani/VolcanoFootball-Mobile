...
public class MesCommandesForm extends BaseForm {
    ...
    private void addCommande(Commande c, Resources res, int i) {

        Button image = new Button();
        image.setUIID("Label");
        Container cnt = BorderLayout.west(image);
          
        Label CommandeTxt = new Label("Commande "+i,"NewsTopLine2");
        Label QuantiteTxt = new Label("Quantité: "+c.getQuantite(),"NewsTopLine2");
        Label AdresseTxt = new Label("Adresse: "+c.getAdresse(),"NewsTopLine2");
        Label DateTxt = new Label("Date: "+c.getDate(),"NewsTopLine2");
