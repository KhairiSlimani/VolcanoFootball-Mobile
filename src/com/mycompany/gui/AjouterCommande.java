...
public class AjouterCommande extends BaseForm {
    ...
    Form current;
    public AjouterCommande (Resources res, Produit p)
    {
        ...
        RadioButton commander = RadioButton.createToggle("Commander", barGroup);
        commander.setUIID("SelectBar");
        ...
        add(LayeredLayout.encloseIn(
                GridLayout.encloseIn(1, commander),
        ...
        addShowListener(e -> {
            ...
            updateArrowPosition(commander, arrow);
        });
        bindButtonSelection(commander, arrow);
        ...
        btnAjouter.addActionListener((e) -> {
            ...
            try{
                ...
                if( quantite.getText().equals("") || adresse.getText().equals(""))
                {
